  ...
  return (
    <div clasName="format lg:format-lg">
      <div className="container mx-auto my-12 mt-4">
        <h2 className="text-4xl text-center my-8 font-bold gap-5">
          Create collections
        </h2>
      ...
      <Box className='flex justify-center items-left gap-5 mt-5'>
        ...
        <Box className="flex justify-center">
          {' '}
          <Button
            onClick={handleSubmit(connectCreateCollectService)}
            className="text-white mt-4 bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300  font-medium rounded-lg text-sm px-10 py-3 text-center mr-2 mb-2"
          >
            submit
          </Button>
        </Box>
